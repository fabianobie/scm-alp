...
public class BackupAsiGeradorComponentPojoClass extends GeradorComponentPojoClass {
	private Component component;
	
	public BackupAsiGeradorComponentPojoClass(Component component, Cfg2JavaTool cfg) {
		super(component, cfg);
