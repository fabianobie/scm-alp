...
/**
 * Formatador default de inteiro.
 * 
 * @author adrianop
 */
public class FormatadorDeInteger extends FormatadorAbstrato<Integer> {
	 ...
	 */
	public String formatar(Integer objeto) throws FormatadorException {
