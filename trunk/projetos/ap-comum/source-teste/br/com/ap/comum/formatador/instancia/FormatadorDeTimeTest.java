 ...
 * 
 * @author adrianop
 * @see FormatadorDeTime
 */
public class FormatadorDeTimeTest extends TesteAbstrato {

	/**
	 * Test method for
	 * {@link br.com.ap.comum.formatador.instancia.FormatadorDeTime#formatar(java.sql.Time)}.
	 * @throws FormatadorException Exceção de formatação 
	 */
	@Test
	public final void testFormatar() throws FormatadorException {
		Time b = getDataFactory().novoTime(04, 30, 35);
		IFormatador<Time> f = getFormatadorFactory().novoFormatadorDeTime();

		String string = f.formatar(b);
		assertNotNull(string);
		assertEquals("04:30", string);
