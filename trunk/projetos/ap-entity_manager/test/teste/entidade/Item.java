...
public class Item implements Entidade {
	...
	@EmbeddedId
	@AttributeOverrides( {
			@AttributeOverride(name = "numeroPedido", column = @Column(name = "nro_ped", unique = false, nullable = false, insertable = true, updatable = true)),
			@AttributeOverride(name = "numeroItem", column = @Column(name = "nro_item", unique = false, nullable = false, insertable = true, updatable = true)) })
	public ItemId getId() {
		return this.id;
	}
	 ...
	 * @return quantidade
	 */
	@Column(name = "qtde", unique = false, nullable = false, insertable = true, updatable = true, precision = 5, scale = 0)
